...
namespace tdd
{
    ...
    public class Tests
    {
        ...
        public void InvertCustomerOnDatabase()
        {
            ...
            // var result = new EntityFrameworkDatabase<Customer>().All();
            //
            ...
            // new DapperDatabase<Customer>().Save(new Customer()
            // {
            //     Name = "Patrik Oliveira",
            //     Phone = "(11)99999-9999"
            // });

            // var result = new DapperDatabase<Customer>().All();
            //
            ...
            // new DapperDatabase<Customer>().Remove(new Customer()
            // {
            //     Id = 1
            // });
        }
