...
namespace tdd
{
    ...
    public class Tests
    {
        ...
        public void InvertCustomerOnDatabase()
        {
            ...
            #region [ EXERCICIO ENTITY FRAMEWORK GENERIC ]
            //GetAll
            new EntityFrameworkDatabase<Customer>().All();

            //Update
            new EntityFrameworkDatabase<Customer>().Update(new Customer()
            {
                Id = 2,
            ...
            //Remove
            new EntityFrameworkDatabase<Customer>().Remove(new Customer()
            {
                Id = 8,
            });
